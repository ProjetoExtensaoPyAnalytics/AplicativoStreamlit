...
def pagina_inicial():
    ...
    with col1:
        st.markdown(f"""
        <a href="/?page=Vacina" target="_self" style="text-decoration: none;">
    ...
    with col2:
        st.markdown(f"""
        <a href="/?page=Saneamento" target="_self" style="text-decoration: none;">
            <div class="clickable-container" style="background-color:#007cc2; padding:20px; border-radius:10px; margin-bottom:15px; box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.1); text-align:center;">
    ...
    with col3:
        st.markdown(f"""
        <a href="/?page=Óbitos" target="_self" style="text-decoration: none;">
            <div class="clickable-container" style="background-color:#fff500; padding:20px; border-radius:10px; margin-bottom:15px; box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.1); text-align:center;">
    ...
    with col4:
        st.markdown(f"""
        <a href="/?page=Medicamentos" target="_self" style="text-decoration: none;">
            <div class="clickable-container" style="background-color:#da251c; padding:20px; border-radius:10px; margin-bottom:15px; box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.1); text-align:center;">
...
if page == "Início":
    ...
    # CSS específico para a página de medicamentos
    st.markdown(
        """
        <style>
        .main {background-color: #fffFFF; padding: 20px; border-radius: 8px;}
