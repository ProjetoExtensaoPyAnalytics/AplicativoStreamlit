...
def exibir():
    ...
    visualizacao = st.sidebar.radio(
        ...
        ["Disponibilidade de Medicamentos", "Medicamentos por Apresentação", "Distribuição por Unidade de Saúde", "Classes de Medicamentos"]
    )
...
#aba de medicamentos por apresentacao
    elif visualizacao == "Medicamentos por Apresentação":
