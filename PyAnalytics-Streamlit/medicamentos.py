...
def exibir():
    ...
    #menu para navegar
    st.sidebar.title("Medicamentos")
    visualizacao = st.sidebar.radio(
        "Escolha a visualização:",
        ["Disponibilidade de Medicamentos", "Por Apresentação", "Por Unidade de Saúde", "Por Classes"]
    )

    if visualizacao == "Disponibilidade de Medicamentos":
        st.title("Disponibilidade de Medicamentos")
        st.markdown("""Esta funcionalidade permite verificar se um medicamento específico está disponível na rede de saúde do município. 
...
#aba de medicamentos por apresentacao
    elif visualizacao == "Por Apresentação":
        st.title("Medicamentos por Apresentação")
        st.markdown("""Esta visualização mostra as diferentes apresentações dos medicamentos disponíveis na rede de saúde, 
...
#aba de distribuicao por US
    elif visualizacao == "Por Unidade de Saúde":
